...
def ngram_count_patterns(freq_lexicon, candidates, crisphold, max_rules):
    ...
    sl_tl_defaults = {}
    sl_tl = {}
    ngrams = {}                 # type: Dict[str, Dict[str, Dict[str, int]]]
    ...
    cur_sl_row = []             # type: List[str]
    cur_tl_row = []             # type: List[Dict[str, Any]]
    cur_bt_row = []             # type: List[Dict[str, Any]]
    cur_al_row = []             # type: List[str]
    lineno = 0
